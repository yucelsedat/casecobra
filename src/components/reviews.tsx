...
// bu diziyi alır istenilen adette bölütledikten sonra tek tek bu bölütlere sırayla itemleri ekler - içinde diziler olan bir diziye dönüşür
...
export default function Reviews() {
  return (
    <MaxWidthWrapper className='relative max-w-5xl '>
      <img aria-hidden src="/what-people-are-buying.png" alt="" className='abolute select-none hidden xl:block -left-32 top-1/3'/>      
